...
ann_file_train = 'data/hmdb51/hmdb51_train_split_2_rawframes.txt'
ann_file_val = 'data/hmdb51/hmdb51_val_split_2_rawframes.txt'
ann_file_test = 'data/hmdb51/hmdb51_val_split_2_rawframes.txt'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        ...
        ann_file='data/hmdb51/hmdb51_train_split_2_rawframes.txt',
    ...
    val=dict(
        type='RawframeDataset',
        ann_file='data/hmdb51/hmdb51_val_split_2_rawframes.txt',
        data_prefix='data/hmdb51/rawframes',
        pipeline=[
            dict(
                type='SampleFrames',
...
total_epochs = 30
work_dir = './exp/timesformer_divST_16x4x1_15e_hmdb51s2_rgb_SGB1e5_finetunek400'
gpu_ids = range(0, 2)
omnisource = False
module_hooks = []
